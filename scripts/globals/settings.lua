...
ELEMENTAL_POWER = 0.800; -- Multiplies damage dealt by Elemental and non-drain Dark Magic.
...
ITEM_POWER      = 1.250; -- Multiplies the effect of items such as Potions and Ethers.
...
HARVESTING_BREAK_CHANCE = 0.25; -- % chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.25; -- % chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.25; -- % chance for the hatchet to break during logging.  Set between 0 and 1.
MINING_BREAK_CHANCE     = 0.25; -- % chance for the pickaxe to break during mining.  Set between 0 and 1.
HARVESTING_RATE         = 0.90; -- % chance to recieve an item from haresting.  Set between 0 and 1.
EXCAVATION_RATE         = 0.90; -- % chance to recieve an item from excavation.  Set between 0 and 1.
LOGGING_RATE            = 0.90; -- % chance to recieve an item from logging.  Set between 0 and 1.
...
CHEST_MIN_ILLUSION_TIME  = 10;  -- 30 minutes
...
QM_RESET_TIME = 60; -- Default time (in seconds) you have from killing ???-pop mission NMs to click again and get key item, until ??? resets.
